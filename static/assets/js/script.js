...
window.addEventListener('scroll', () => {
    ...
    if (window.scrollY >= 450) {
        leftBanner.classList.add('poston-actv')
        rightBanner.classList.add('poston-actv')
       
    }
    else {
        leftBanner.classList.remove('poston-actv')
        rightBanner.classList.remove('poston-actv')
...
window.addEventListener('scroll', () => {
    let ferdiLeft = document.querySelector('.ferdi-left')
    let ferdiRight = document.querySelector('.ferdi-right')
    if (window.scrollY >= 30) {
        ferdiLeft.classList.add('poston-actvTwo')
        ferdiRight.classList.add('poston-actvTwo')
    }
    else {
        ferdiLeft.classList.remove('poston-actvTwo')
        ferdiRight.classList.remove('poston-actvTwo')
    }
})
...
window.addEventListener('scroll', () => {
    let oluLeft = document.querySelector('.olu-left')
    let olulazy6 = document.querySelector('.morgues-table')
    let oluRight = document.querySelector('.olu-right') 
    if (olulazy6.children.length < 2) {
        if (window.scrollY >= 450) {
            oluLeft.classList.add('poston-actvTwo')
            oluRight.classList.add('poston-actvTwo')
        }
        else {
            oluLeft.classList.remove('poston-actvTwo')
            oluRight.classList.remove('poston-actvTwo')
        }
    }
    else{
        if (window.scrollY >= 30) {
...
modalBtn.addEventListener('click', (e) => {
    e.stopPropagation()
    if (userModal.className = 'user-modal') {
        showModal()
    } else[
        userModal.classList.remove('userModalActive')
    ]
...
// const opBaku = document.querySelector('.opBaku')

// console.log(document.querySelector('.opBaku'));
...
// let hiddenTwo = document.querySelector('.hidden-two')

// function changeValue() {
//     if (selectCity.value != 'baku') {
...
// let allHidden = document.querySelector('.allHidden')
// function changeValue() {
//     if (selectCity.value = 'allhidden') {
//         hidden.style.display = 'none'
//         hiddenTwo.style.display = 'block'
